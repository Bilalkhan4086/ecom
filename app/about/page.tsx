            ...
            {timeline.map((item) => (
              <div key={item.name}>
                ...
                >
                  ...
                  {item.date}
                  <div
                    className="absolute -ml-2 h-px w-screen -translate-x-full max-lg:hidden bg-white/60 sm:-ml-4 lg:static lg:-mr-6 lg:ml-8 lg:w-auto lg:flex-auto lg:translate-x-0"
                    aria-hidden="true"
                  />
                </time>
                ...
                <p className="mt-1 text-base leading-7 text-blue-200">
                  {item.description}
                </p>
              </div>
            ))}
        ...
        <div className="mt-32 overflow-hidden sm:mt-40">
          <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
              ...
              <div className="flex  max-md:hidden flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
